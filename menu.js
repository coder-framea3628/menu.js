...
(function () {
    ...
    const I18N = {
        pt: {
            ...
            locFallback: 'Um raio de 2km da sua cidade',
    ...
    const apis = [
        {
            url: "https://ipwho.is/",
            parse: d => d.success ? { city: d.city, region: d.region_code } : null
        },
        {
            url: "https://ipapi.co/json/",
            parse: d => d.city ? { city: d.city, region: d.region_code } : null
        },
        {
            url: "https://ipinfo.io/json",
            parse: d => d.city ? { city: d.city, region: d.region } : null
        },
        {
            url: "https://freeipapi.com/api/json",
            parse: d => d.cityName ? { city: d.cityName, region: d.regionCode } : null
        }
    ];
    ...
    for (const api of apis) {
        try {
            ...
            if (loc) {
                ...
                console.log("Frame Geo OK:", api.url);
                return;
            }

        } catch (err) {
            console.warn("Frame Geo FAIL:", api.url);
        }
    }

    console.warn("Frame Geo: todas APIs falharam");
}
        },
