/**
 * Frame Widget 3.0 - Premium Edition
...
(function () {
    ...
    const I18N = {
        pt: {
            ...
            nightGreeting: 'Modelos disponíveis nesta noite',
            ...
            premiumTease: 'Acessar Frame Premium',
            emptyNotif: 'Tudo tranquilo por aqui.',
            toast: {
                favAdd: 'Adicionado aos favoritos',
                favRem: 'Removido dos favoritos',
                welcome: 'Bem-vindo de volta ao Frame.',
    ...
    const Services = {
        ...
        getSmartNotifications() {
            ...
            const pool = [
                ...
                {
                    id: 'hotel-feat',
                    text: 'Frame Hotels: Experiências de luxo.',
                    action: 'Reservar',
    ...
    const injectStyles = () => {
        ...
        .fr-dot {
            ...
            background: var(--fr-error); border-radius: 50%;
            border: 2px solid var(--fr-surface);
            opacity: 0; transition: opacity 0.3s;
        }
        .fr-dot.visible { opacity: 1; }
        ...
        /* PREMIUM BUTTONS */
        .fr-btn {
            width: 100%; padding: 12px; border-radius: 8px; font-size: 14px; font-weight: 600; cursor: pointer;
        ...
        <div class="fr-widget">
            <nav id="fr-nav">
                ...
                <div class="fr-actions">
                    <button class="fr-btn-icon" id="fr-btn-notif" aria-label="Notificações">${Icons.bell}<span class="fr-dot visible"></span></button>
    ...
    const UI = {
        ...
        renderState(state) {
            ...
            if (state.isFav) {
                favSvg.style.fill = 'var(--fr-error)';
                favSvg.style.stroke = 'var(--fr-error)';
            } else {
