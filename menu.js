...
// ===== Injetar CSS (otimizado e ajustado) =====
...
.icon-wrapper{display:flex;align-items:center;gap:22px}
#navMenu svg,#navMenu img{width:28px;height:28px;cursor:pointer;transition:all .3s cubic-bezier(0.25,0.46,0.45,0.94);vertical-align:middle}
...
// ===== Injetar HTML (sem chat, links em nova aba) =====
const navHTML = `
<div id="navMenu" role="navigation" aria-label="Menu principal">
  ...
  <div class="icon-wrapper">
    ...
    <a href="https://frameag.com/chat" target="_blank" style="display:inline-block;" aria-label="Abrir chat">
    ...
    <a href="https://frameag.com/login" target="_blank" style="display:inline-block;" aria-label="Fazer login">
...
favIcon?.addEventListener('click', () => {
  ...
  showToast(filled ? 'Adicionada as suas favoritas' : 'Removida das favoritas');
});
