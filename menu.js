...
// ===== Injetar CSS (otimizado com logo) =====
...
#navMenu svg:hover,#navMenu img:not(.logo-img):hover{transform:scale(1.08) rotate(5deg);filter:drop-shadow(0 2px 4px rgba(142,110,74,0.3))}
...
// ===== Injetar HTML (com logo no canto esquerdo) =====
const navHTML = `
