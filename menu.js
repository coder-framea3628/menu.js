...
<div class="overlay" id="notifOverlay">
  <div class="popup" id="notifPopup">
    ...
    <div class="notif-item">
      ...
      <button onclick="handleRedirect('https://frameag.com/models', 'Ver Modelos?')">Ver catálogo de modelos</button>
    </div>
...
<div id="chatContainer" class="c" style="display:none;">
  ...
  <div class="f">
    <span>Deseja suporte 24? Envie um e-mail para: contato@frameag.com</span>
  </div>
  <div class="input-box">
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  window.sendMessage = function () {
    ...
    setTimeout(() => {
      ...
      botWrap.innerHTML = `<img src="https://via.placeholder.com/26?text=IA" alt="bot"><div class="bb">Recebi sua mensagem: "${escapeHtml(text)}"</div>`;
